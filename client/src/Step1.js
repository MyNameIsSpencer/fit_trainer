            ...
            <tr>
              <th className="seperator">
                <ul className="home-ul">
                  <li><button onClick={(e, loseWeight) => this.handleClick(e, optionDescriptions.loseWeight)}>
                      Lose Weight </button></li>
                  <li><button onClick={(e, loseWeight) => this.handleClick(e, optionDescriptions.reduceStress)}>
                      Reduce Stress</button></li>
                  <li><button onClick={(e, loseWeight) => this.handleClick(e, optionDescriptions.improveHealth)}>
                    Improve Health</button></li>
                  <li><button onClick={(e, loseWeight) => this.handleClick(e, optionDescriptions.getFitter)}>
                    Get Fitter</button></li>
                  <li><button onClick={(e, loseWeight) => this.handleClick(e, optionDescriptions.notSure)}>
                    Not Sure</button></li>
                </ul>
              </th>
